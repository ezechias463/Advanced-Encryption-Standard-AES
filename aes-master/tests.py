import unittest
from aesops import encrypt, decrypt
from aes import AES
...
class TestFunctions(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.encrypt = lambda key, ciphertext: encrypt("cbc", key, ciphertext, 10000)
        self.decrypt = lambda key, ciphertext: decrypt("cbc", key, ciphertext, 10000)
